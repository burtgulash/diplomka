...
7.87 & Ten Commandments Number 1: Thou Shalt Not Adore \boldred{False} \boldred{God}s, The \\
8.15 & \boldred{Fatal} Lessons: The \boldred{Goo}d Teacher \\
8.29 & \boldred{Fable} of One Samaritan Who \boldred{Got} Paralysis of the Helping Hand, The \\
\end{tabulary}
\end{minipage}
\begin{minipage}[t]{.5\textwidth}\vspace{0pt}
...
\caption{Výsledky dotazu \bftt{God father}}
