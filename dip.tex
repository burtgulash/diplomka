...
\paragraph{Keywords}
Approximate Text Search, Prefix Search, Proximity Search, Autocomplete, Search
As You Type, Error Tolerant Text Search, Half-Inverted Index, Hybrid Index,
Inverted Index
...
lemmatizace, která místo kmene slova hledá jeho základní (slovníkový) tvar.
