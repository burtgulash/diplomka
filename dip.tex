...
Důraz je kladen především na prefixové a přibližné vyhledávání, které jsou
...
\subsubsection{Nalezení minimálního intervalu}
...
blízkosti, nebo jiného faktoru~\cite{algolia_ranking}. Tie-breaking sice
...
V této části bude popsán navrhovaný vyhledávací systém s použitím technik popsaných výše.
...
\subsubsection{ElasticSearch - Trigramový vyhledávač}
