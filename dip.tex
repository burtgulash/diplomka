...
odpovídajícími požadavkům a očekáváním dnešní doby, které jsou ale opomíjené,
protože implementace technik, které by je splňovaly, není jednoduchá, nebo
...
hardwaru ale přináší šanci pro problémy, na které nebyl kladen důraz pro jejich
příliš velkou výpočetní náročnost na dřívější dobu.
...
požadavky lidí a firem a větší objemy dat. Systém, který bude navrhnut v této
práci se proto nesnaží být nejlepším řešením pro všechny případy a explicitně
se zaměřuje na specifičtější případy, ve kterých by přibližné vyhledávání
přineslo velkou hodnotu. Kompromisem je, že se navrhovaný systém nesnaží jít
stejnou cestou velkých dat (Big Data), které je v současné době žhavým tématem.
Přesně opačně by mělo představované řešení nalézt uplatnění pro menší objemy
dat (Small Data), které jsou dle nejen mého názoru opomíjené.
