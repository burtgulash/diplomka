...
po slovu (term-at-a-time, TAAT). Ta nejprve získá invertované seznamy každého
...
identifikátor po druhém (document-at-a-time, DAAT). I zde platí, že konjunkce
je nejefektivnější po předseřazení seznamů podle velikosti. Oproti první má
tahle strategie výhodu pro dotazy typu \uv{konjunkce disjunkcí}, protože
disjunkce nemusí materializovat před tím, než je sloučí. Zároveň využije
častého přeskakování u průniku, čímž vynechá spoustu operací u disjunkce, které
by jinak byly vykonány.

Nejjednodušším způsobem průniku je lineární průchod seznamy a postupným
...
Disjunktivní sloučení není pro aplikaci v invertovaných seznamech příliš
prozkoumáno, protože je není oproti konjunktivnímu slučování klíčovým prvkem
vykonání dotazu. U hybridních indexů ale klíčovým je, proto bude nastíněno
několik způsobů, jak ho provést.
