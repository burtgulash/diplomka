...
slučovat od nejmenšího po největší. Tenhle přístup používá knihovna Apache
Lucene.
...
tím, že uložíme pouze rozdíly mezi identifikátory, které budou vždy nezáporné,
protože je posloupnost vzrůstající. Tyto rozdíly budou oproti původním
identifikátorům pouze poměrně malá čísla, které můžeme zmenšit kompresními kódy
pro celá čísla.
...
kódy Elias-Gamma a Elias-Delta, nebo bytově orientované schéma VarByte. Bitové
kódy jsou kompaktnější, ale bytové rychlejší pro dekódování na současných
procesorových architekturách.
