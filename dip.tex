...
inkrementálního vyhledávání - autocomplete, instant search, typeahead search,
...
Plná forma inkrementálního vyhledávání je striktně náročnější na výpočetní
výkon, protože vykonává plný dotaz pro každé písmeno dotazu. Proto je populární
slabší forma dvou uživatelských rozhraní, která vykoná pouze výpočetně méně
náročnou verzi dotazu při každém novém písmenu.

Příkladem by mohlo být vyhledávání pouze v titulcích nebo názvech dokumentů při
...
struktuře, kterou označíme jako slovník. 
