...
obtížný, existuje více specifických zaměření, než jedno obecné a perfektní.
...
používají techniky navrhované pro příliš obecné a zdrojově náročné prohledávání
Webu a nedosahují takových výsledků, jakých by mohly, nebo za příliš vysokou
cenu komplikovaných řešení. 
