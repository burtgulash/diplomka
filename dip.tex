...
výsledek nebo výsledky dle relevance k jeho dotazu.
...
Pořadí by mělo být možné doupravit nějakým preferenčním pořadím (podle času,
podle ceny, počtu zhlédnutí, apod.). Přesto by měla mít textová shoda největší
význam, jinak by mohl mít uživatel pocit, že si buď vyhledávač vymýšlí, má
nízkou přesnost, nebo se mu někdo snaží něco vnutit (např. upřednostněné
produkty v eshopu).
...
\subsubsection{Plane sweep algoritmus}
\subsubsection{Preference prvního}
\subsubsection{Modifikace}
