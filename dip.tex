...
slovo, které odpovídají prefixu. Všechna slova mezi nimi jsou výsledkem hledání
prefixu. Tuto reprezentaci můžeme efektivně komprimovat technikou Front-Coding,
...
funguje pro slova přirozeného jazyka, protože díky tendenci výskytu morfologie
ke konci slov se ve slovníku bude objevovat značné množství silně
...
množiny všech n-gramů v dokumentu. Naopak editační vzdálenost se vyhodnotí už
ve slovníku ještě před přístupem do invertovaných seznamů. Existuje více
datových struktur, které umožňují efektivní vyhledání všech slov do určité
vzdálenosti od hledaného - tedy bez vyčerpávajícího průchodu celým slovníkum.
